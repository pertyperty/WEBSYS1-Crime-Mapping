...
<body>
    ...
    <div class="modal-overlay" id="user-details-modal">
        <div class="modal-content user-modal">
            ...
            <div class="modal-actions">
                ...
                <button type="button" class="btn-secondary" id="edit-user">Edit</button>
    ...
    <script>
        ...
        function openUserDetails(user) {
            selectedUser = user;
            document.getElementById('user-details-title').textContent = user.username;
            ...
            document.getElementById('user-details-modal').classList.add('is-open');
        }
        ...
        function renderUsers() {
            ...
            filtered.forEach((user) => {
                ...
                row.querySelector('[data-action="view"]').addEventListener('click', () => openUserDetails(user));
                row.querySelector('[data-action="edit"]').addEventListener('click', () => openUserForm('edit', user));
